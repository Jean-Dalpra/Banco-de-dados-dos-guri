...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-12">
            <div class="row">
                <div class="col-3">
                    <h1 class="text-center" style="text-decoration:underline; padding: 10px; border-radius:10px; background-color: #8b48cf; margin-top: 42px; margin-left: 550px; width: 260px;">SOULSLIKE</h1>
                </div>
            </div>
            <div class="row">
               <ul class="col-12">
